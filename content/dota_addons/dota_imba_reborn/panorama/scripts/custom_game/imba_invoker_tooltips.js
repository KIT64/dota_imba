...
function PlainText(text) 
{
	...
	{
		$.Msg("Failed to convert tooltip text: " + text)
	}
}
...
function ColorizeInvokerTooltip(slot_number) 
{
	...
	{	
		...
		if (invoker != null) 
		{
			...
			//$.Msg("Q: " + quas_lvl + " W: " + wex_lvl + " E: " + exort_lvl)
	...
	{
		$.Msg("Tried to invoke invoker tooltip function wrong hero-class")
	}
}
...
//$.Msg(DotaHud.FindChildTraverse("DOTAAbilityTooltip").FindChildTraverse("AbilityName").text)
//$.Msg(DotaHud.FindChildTraverse("DOTAAbilityTooltip").FindChildTraverse('AbilityExtraAttributes'))
//$.Msg(DotaHud.FindChildTraverse("DOTAAbilityTooltip").FindChildTraverse('AbilityCoreDetails').GetChild(6).id)
//$.Msg(DotaHud.FindChildTraverse("DOTAAbilityTooltip").FindChildTraverse('AbilityCoreDetails'))
